  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
      ...
      <div 
        ...
        className="relative w-full max-w-4xl bg-white/90 shadow-2xl shadow-pink-300/50 rounded-[48px] overflow-hidden flex flex-col border border-white/50 animate-in zoom-in-95 duration-300"
      >
        {/* Header */}
        <div className="bg-pink-500 p-8 md:p-12 text-white flex justify-between items-start print:bg-white print:text-pink-600 print:p-4">
          <div>
            <div className="flex items-center gap-4 mb-2">
              <Heart className="fill-white print:fill-pink-500 text-white print:text-pink-500" size={32} />
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter italic print:text-pink-600">Daily Summary</h2>
            </div>
            <p className="mt-2 text-pink-100 font-medium print:text-pink-400 opacity-90">{today}</p>
          </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-8 md:p-12 space-y-12 custom-scrollbar print:overflow-visible print:p-4">
          ...
          <div>
            ...
            <div className="bg-white p-6 rounded-3xl border border-pink-100 shadow-sm print:shadow-none">
        ...
        {/* Footer */}
        <div className="p-8 text-center text-[10px] text-pink-300 font-bold uppercase tracking-widest border-t border-pink-50 flex items-center justify-center gap-2 print:border-none">
